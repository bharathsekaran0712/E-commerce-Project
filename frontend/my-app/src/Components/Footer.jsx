    ...
    md:text-left py-5'>
      ...
      <div className="flex-1 min-w-62.5 items-center gap-4">
        ...
        <a href='#' target='_blank'>
          <Github className='w-7 h-7 text-gray-400 transition-transform duration-300
          hover:scale-110 hover:text-blue-500'/>
        </a>
        <a href="#" target='_blank'>
          <Linkedin className='w-7 h-7 text-gray-400 transition-transform duration-300
          hover:scale-110 hover:text-blue-500'/>
        </a>
        <a href="#" target='_blank'>
          <Youtube className='w-7 h-7 text-gray-400 transition-transform duration-300
          hover:scale-110 hover:text-red-500'/>
        </a>
        <a href="#" target='_blank'>
          <Instagram className='w-7 h-7 text-gray-400 transition-transform duration-300
      ...
      <div className="flex-1 min-w-62.5 ">
        ...
        <p className='text-gray-400 leading-relaxed'>Providing professional solution to help grow your online business</p>
      </div>
    </div>
    
    <div className="border-t border-gray-700 py-4 text-center text-gray-400 text-sm">© 2026 Shopping hub. All rights reserved</div>
    </footer>
  )
}
